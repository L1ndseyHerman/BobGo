...
public class LevelFourActivity extends AppCompatActivity
{
    ...
    public GridImageThing[][] placeGridImages(GridImageThing[][] daGrid)
    {
        ...
        daGrid[43][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_43x4), screenWidth, screenHeight);
        daGrid[43][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_43x5), screenWidth, screenHeight);
        ...
        daGrid[44][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_44x4), screenWidth, screenHeight);
        daGrid[44][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_44x5), screenWidth, screenHeight);
        ...
        daGrid[45][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_45x2), screenWidth, screenHeight);
        daGrid[45][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_45x3));
        daGrid[45][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_45x4), screenWidth, screenHeight);
        daGrid[45][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_45x5), screenWidth, screenHeight);

        daGrid[46][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_46x0), screenWidth, screenHeight);
        daGrid[46][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_46x1));
        daGrid[46][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_46x2), screenWidth, screenHeight);
        daGrid[46][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_46x3));
        daGrid[46][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_46x4), screenWidth, screenHeight);
        daGrid[46][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_46x5), screenWidth, screenHeight);

        daGrid[47][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_47x0), screenWidth, screenHeight);
        daGrid[47][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_47x1));
        daGrid[47][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_47x2), screenWidth, screenHeight);
        daGrid[47][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_47x3));
        daGrid[47][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_47x4), screenWidth, screenHeight);
        daGrid[47][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_47x5), screenWidth, screenHeight);

        daGrid[48][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_48x0), screenWidth, screenHeight);
        daGrid[48][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_48x1));
        daGrid[48][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_48x2), screenWidth, screenHeight);
        daGrid[48][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_48x3));
        daGrid[48][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_48x4), screenWidth, screenHeight);
        daGrid[48][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_48x5), screenWidth, screenHeight);

        daGrid[49][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_49x0), screenWidth, screenHeight);
        daGrid[49][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_49x1));
        daGrid[49][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_49x2), screenWidth, screenHeight);
        daGrid[49][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_49x3));
        daGrid[49][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_49x4), screenWidth, screenHeight);
        daGrid[49][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_49x5), screenWidth, screenHeight);

        daGrid[50][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_50x0), screenWidth, screenHeight);
        daGrid[50][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_50x1));
        daGrid[50][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_50x2), screenWidth, screenHeight);
        daGrid[50][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_50x3));
        daGrid[50][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_50x4), screenWidth, screenHeight);
        daGrid[50][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_50x5), screenWidth, screenHeight);

        daGrid[51][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_51x0), screenWidth, screenHeight);
        daGrid[51][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_51x1));
        daGrid[51][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_51x2), screenWidth, screenHeight);
        daGrid[51][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_51x3));
        daGrid[51][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_51x4), screenWidth, screenHeight);
        daGrid[51][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_51x5), screenWidth, screenHeight);

        daGrid[52][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_52x0), screenWidth, screenHeight);
        daGrid[52][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_52x1));
        daGrid[52][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_52x2), screenWidth, screenHeight);
        daGrid[52][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_52x3));
        daGrid[52][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_52x4), screenWidth, screenHeight);
        daGrid[52][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_52x5), screenWidth, screenHeight);

        daGrid[53][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_53x0), screenWidth, screenHeight);
        daGrid[53][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_53x1));
        daGrid[53][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_53x2), screenWidth, screenHeight);
        daGrid[53][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_53x3));
        daGrid[53][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_53x4), screenWidth, screenHeight);
        daGrid[53][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_53x5), screenWidth, screenHeight);

        daGrid[54][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_54x0), screenWidth, screenHeight);
        daGrid[54][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_54x1));
        daGrid[54][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_54x2), screenWidth, screenHeight);
        daGrid[54][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_54x3));
        daGrid[54][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_54x4), screenWidth, screenHeight);
        daGrid[54][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_54x5), screenWidth, screenHeight);

        daGrid[55][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_55x0), screenWidth, screenHeight);
        daGrid[55][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_55x1));
        daGrid[55][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_55x2), screenWidth, screenHeight);
        daGrid[55][3] = new SquareObstacle((ImageView) findViewById(R.id.grid4_55x3), screenWidth, screenHeight);
        daGrid[55][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_55x4), screenWidth, screenHeight);
        daGrid[55][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_55x5), screenWidth, screenHeight);
        ...
        daGrid[56][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_56x2), screenWidth, screenHeight);
        daGrid[56][3] = new SquareObstacle((ImageView) findViewById(R.id.grid4_56x3), screenWidth, screenHeight);
        daGrid[56][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_56x4), screenWidth, screenHeight);
        daGrid[56][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_56x5), screenWidth, screenHeight);
        ...
        daGrid[57][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_57x4), screenWidth, screenHeight);
        daGrid[57][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_57x5), screenWidth, screenHeight);
        ...
        daGrid[58][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_58x4), screenWidth, screenHeight);
        daGrid[58][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_58x5), screenWidth, screenHeight);
        ...
        daGrid[59][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_59x2), screenWidth, screenHeight);
        daGrid[59][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_59x3));
        daGrid[59][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_59x4), screenWidth, screenHeight);
        daGrid[59][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_59x5), screenWidth, screenHeight);

        daGrid[60][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_60x0), screenWidth, screenHeight);
        daGrid[60][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_60x1));
        daGrid[60][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_60x2), screenWidth, screenHeight);
        daGrid[60][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_60x3));
        daGrid[60][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_60x4), screenWidth, screenHeight);
        daGrid[60][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_60x5), screenWidth, screenHeight);

        daGrid[61][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_61x0), screenWidth, screenHeight);
        daGrid[61][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_61x1));
        daGrid[61][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_61x2), screenWidth, screenHeight);
        daGrid[61][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_61x3));
        daGrid[61][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_61x4), screenWidth, screenHeight);
        daGrid[61][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_61x5), screenWidth, screenHeight);

        daGrid[62][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_62x0), screenWidth, screenHeight);
        daGrid[62][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_62x1));
        daGrid[62][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_62x2), screenWidth, screenHeight);
        daGrid[62][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_62x3));
        daGrid[62][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_62x4), screenWidth, screenHeight);
        daGrid[62][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_62x5), screenWidth, screenHeight);

        daGrid[63][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_63x0), screenWidth, screenHeight);
        daGrid[63][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_63x1));
        daGrid[63][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_63x2), screenWidth, screenHeight);
        daGrid[63][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_63x3));
        daGrid[63][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_63x4), screenWidth, screenHeight);
        daGrid[63][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_63x5), screenWidth, screenHeight);

        daGrid[64][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_64x0), screenWidth, screenHeight);
        daGrid[64][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_64x1));
        daGrid[64][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_64x2), screenWidth, screenHeight);
        daGrid[64][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_64x3));
        daGrid[64][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_64x4), screenWidth, screenHeight);
        daGrid[64][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_64x5), screenWidth, screenHeight);

        daGrid[65][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_65x0), screenWidth, screenHeight);
        daGrid[65][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_65x1));
        daGrid[65][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_65x2), screenWidth, screenHeight);
        daGrid[65][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_65x3));
        daGrid[65][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_65x4), screenWidth, screenHeight);
        daGrid[65][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_65x5), screenWidth, screenHeight);

        daGrid[66][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_66x0), screenWidth, screenHeight);
        daGrid[66][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_66x1));
        daGrid[66][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_66x2), screenWidth, screenHeight);
        daGrid[66][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_66x3));
        daGrid[66][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_66x4), screenWidth, screenHeight);
        daGrid[66][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_66x5), screenWidth, screenHeight);

        daGrid[67][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_67x0), screenWidth, screenHeight);
        daGrid[67][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_67x1));
        daGrid[67][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_67x2), screenWidth, screenHeight);
        daGrid[67][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_67x3));
        daGrid[67][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_67x4), screenWidth, screenHeight);
        daGrid[67][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_67x5), screenWidth, screenHeight);

        daGrid[68][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_68x0), screenWidth, screenHeight);
        daGrid[68][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_68x1));
        daGrid[68][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_68x2), screenWidth, screenHeight);
        daGrid[68][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_68x3));
        daGrid[68][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_68x4), screenWidth, screenHeight);
        daGrid[68][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_68x5), screenWidth, screenHeight);

        daGrid[69][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_69x0), screenWidth, screenHeight);
        daGrid[69][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_69x1));
        daGrid[69][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_69x2), screenWidth, screenHeight);
        daGrid[69][3] = new SquareObstacle((ImageView) findViewById(R.id.grid4_69x3), screenWidth, screenHeight);
        daGrid[69][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_69x4), screenWidth, screenHeight);
        daGrid[69][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_69x5), screenWidth, screenHeight);
        ...
        daGrid[70][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_70x4), screenWidth, screenHeight);
        daGrid[70][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_70x5), screenWidth, screenHeight);
        ...
        daGrid[71][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_71x4), screenWidth, screenHeight);
        daGrid[71][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_71x5), screenWidth, screenHeight);
        ...
        daGrid[74][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_74x4), screenWidth, screenHeight);
        daGrid[74][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_74x5));

        daGrid[75][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_75x0), screenWidth, screenHeight);
        daGrid[75][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_75x1), screenWidth, screenHeight);
        daGrid[75][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_75x2), screenWidth, screenHeight);
        daGrid[75][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_75x3));
        daGrid[75][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_75x4), screenWidth, screenHeight);
        daGrid[75][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_75x5));

        daGrid[76][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_76x0), screenWidth, screenHeight);
        daGrid[76][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_76x1), screenWidth, screenHeight);
        daGrid[76][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_76x2), screenWidth, screenHeight);
        daGrid[76][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_76x3));
        daGrid[76][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_76x4), screenWidth, screenHeight);
        daGrid[76][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_76x5));

        daGrid[77][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_77x0), screenWidth, screenHeight);
        daGrid[77][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_77x1), screenWidth, screenHeight);
        daGrid[77][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_77x2), screenWidth, screenHeight);
        daGrid[77][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_77x3));
        daGrid[77][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_77x4), screenWidth, screenHeight);
        daGrid[77][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_77x5));

        daGrid[78][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_78x0), screenWidth, screenHeight);
        daGrid[78][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_78x1), screenWidth, screenHeight);
        daGrid[78][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_78x2), screenWidth, screenHeight);
        daGrid[78][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_78x3));
        daGrid[78][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_78x4), screenWidth, screenHeight);
        daGrid[78][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_78x5));

        daGrid[79][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_79x0), screenWidth, screenHeight);
        daGrid[79][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_79x1), screenWidth, screenHeight);
        daGrid[79][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_79x2), screenWidth, screenHeight);
        daGrid[79][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_79x3));
        daGrid[79][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_79x4), screenWidth, screenHeight);
        daGrid[79][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_79x5));

        daGrid[80][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_80x0), screenWidth, screenHeight);
        daGrid[80][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_80x1), screenWidth, screenHeight);
        daGrid[80][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_80x2), screenWidth, screenHeight);
        daGrid[80][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_80x3));
        daGrid[80][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_80x4), screenWidth, screenHeight);
        daGrid[80][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_80x5));

        daGrid[81][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_81x0), screenWidth, screenHeight);
        daGrid[81][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_81x1), screenWidth, screenHeight);
        daGrid[81][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_81x2), screenWidth, screenHeight);
        daGrid[81][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_81x3));
        daGrid[81][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_81x4), screenWidth, screenHeight);
        daGrid[81][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_81x5));

        daGrid[82][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_82x0), screenWidth, screenHeight);
        daGrid[82][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_82x1), screenWidth, screenHeight);
        daGrid[82][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_82x2), screenWidth, screenHeight);
        daGrid[82][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_82x3));
        daGrid[82][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_82x4), screenWidth, screenHeight);
        daGrid[82][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_82x5));

        daGrid[83][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_83x0), screenWidth, screenHeight);
        daGrid[83][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_83x1), screenWidth, screenHeight);
        daGrid[83][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_83x2), screenWidth, screenHeight);
        daGrid[83][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_83x3));
        daGrid[83][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_83x4), screenWidth, screenHeight);
        daGrid[83][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid4_83x5));

        daGrid[84][0] = new SquareObstacle((ImageView) findViewById(R.id.grid4_84x0), screenWidth, screenHeight);
        daGrid[84][1] = new SquareObstacle((ImageView) findViewById(R.id.grid4_84x1), screenWidth, screenHeight);
        daGrid[84][2] = new SquareObstacle((ImageView) findViewById(R.id.grid4_84x2), screenWidth, screenHeight);
        daGrid[84][3] = new SquareObstacle((ImageView) findViewById(R.id.grid4_84x3), screenWidth, screenHeight);
        daGrid[84][4] = new SquareObstacle((ImageView) findViewById(R.id.grid4_84x4), screenWidth, screenHeight);
        daGrid[84][5] = new SquareObstacle((ImageView) findViewById(R.id.grid4_84x5), screenWidth, screenHeight);
