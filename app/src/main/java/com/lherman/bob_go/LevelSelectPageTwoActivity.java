...
public class LevelSelectPageTwoActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        buttons[2].setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent startIntent = new Intent(getApplicationContext(), LevelSevenActivity.class);
                startActivity(startIntent);
            }
        });
        ...
        buttons[3].setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent startIntent = new Intent(getApplicationContext(), LevelEightActivity.class);
                startActivity(startIntent);
            }
        });
