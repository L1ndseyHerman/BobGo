...
public class LevelOneActivity extends AppCompatActivity
{
    ...
    public GridImageThing[][] placeGridImages(GridImageThing[][] daGrid)
    {
        ...
        daGrid[12][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_12x4), screenWidth, screenHeight);
        daGrid[12][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_12x5));
        ...
        daGrid[13][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_13x3), screenWidth, screenHeight);
        ...
        daGrid[19][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_19x3), screenWidth, screenHeight);
        daGrid[19][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_19x4), screenWidth, screenHeight);
        ...
        daGrid[20][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_20x3));
        daGrid[20][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_20x4));
        daGrid[20][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_20x5), screenWidth, screenHeight);
        ...
        daGrid[21][2] = new SquareObstacle((ImageView) findViewById(R.id.grid1_21x2), screenWidth, screenHeight);
        daGrid[21][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_21x3), screenWidth, screenHeight);
        daGrid[21][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_21x4));
        daGrid[21][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_21x5), screenWidth, screenHeight);
        ...
        daGrid[22][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_22x5), screenWidth, screenHeight);
        ...
        daGrid[23][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_23x5), screenWidth, screenHeight);
        ...
        daGrid[26][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_26x5), screenWidth, screenHeight);
        ...
        daGrid[27][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_27x4), screenWidth, screenHeight);
        ...
        daGrid[28][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_28x3), screenWidth, screenHeight);
        daGrid[28][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_28x4), screenWidth, screenHeight);
        daGrid[28][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_28x5), screenWidth, screenHeight);
        ...
        daGrid[29][2] = new SquareObstacle((ImageView) findViewById(R.id.grid1_29x2), screenWidth, screenHeight);
        daGrid[29][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_29x3), screenWidth, screenHeight);
        daGrid[29][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_29x4), screenWidth, screenHeight);
        daGrid[29][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_29x5), screenWidth, screenHeight);
        ...
        daGrid[30][2] = new SquareObstacle((ImageView) findViewById(R.id.grid1_30x2), screenWidth, screenHeight);
        daGrid[30][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_30x3), screenWidth, screenHeight);
        daGrid[30][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_30x4), screenWidth, screenHeight);
        daGrid[30][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_30x5), screenWidth, screenHeight);
        ...
        daGrid[31][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_31x3), screenWidth, screenHeight);
        daGrid[31][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_31x4), screenWidth, screenHeight);
        daGrid[31][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_31x5), screenWidth, screenHeight);
        ...
        daGrid[34][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_34x5), screenWidth, screenHeight);
        ...
        daGrid[35][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_35x5), screenWidth, screenHeight);
        ...
        daGrid[36][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_36x4), screenWidth, screenHeight);
        daGrid[36][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_36x5), screenWidth, screenHeight);
        ...
        daGrid[37][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_37x3), screenWidth, screenHeight);
        daGrid[37][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_37x4), screenWidth, screenHeight);
        ...
        daGrid[38][2] = new SquareObstacle((ImageView) findViewById(R.id.grid1_38x2), screenWidth, screenHeight);
        daGrid[38][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_38x3), screenWidth, screenHeight);
        daGrid[38][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_38x4), screenWidth, screenHeight);
        daGrid[38][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_38x5), screenWidth, screenHeight);
        ...
        daGrid[43][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_43x5), screenWidth, screenHeight);
        ...
        daGrid[45][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_45x5));
        ...
        daGrid[49][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_49x0));
        daGrid[49][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_49x1));
        daGrid[49][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_49x2));
        daGrid[49][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_49x3));
        daGrid[49][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_49x4));
        daGrid[49][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_49x5));

        daGrid[50][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_50x0));
        daGrid[50][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_50x1));
        daGrid[50][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_50x2));
        daGrid[50][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_50x3));
        daGrid[50][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_50x4));
        daGrid[50][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_50x5));

        daGrid[51][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_51x0));
        daGrid[51][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_51x1));
        daGrid[51][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_51x2));
        daGrid[51][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_51x3));
        daGrid[51][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_51x4));
        daGrid[51][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_51x5), screenWidth, screenHeight);

        daGrid[52][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_52x0));
        daGrid[52][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_52x1));
        daGrid[52][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_52x2));
        daGrid[52][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_52x3));
        daGrid[52][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_52x4));
        daGrid[52][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_52x5));

        daGrid[53][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_53x0));
        daGrid[53][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_53x1));
        daGrid[53][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_53x2));
        daGrid[53][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_53x3));
        daGrid[53][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_53x4));
        daGrid[53][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_53x5));

        daGrid[54][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_54x0));
        daGrid[54][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_54x1));
        daGrid[54][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_54x2));
        daGrid[54][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_54x3));
        daGrid[54][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_54x4));
        daGrid[54][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_54x5));

        daGrid[55][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_55x0));
        daGrid[55][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_55x1));
        daGrid[55][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_55x2));
        daGrid[55][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_55x3));
        daGrid[55][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_55x4));
        daGrid[55][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_55x5));

        daGrid[56][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_56x0));
        daGrid[56][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_56x1));
        daGrid[56][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_56x2));
        daGrid[56][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_56x3));
        daGrid[56][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_56x4));
        daGrid[56][5] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_56x5));

        daGrid[57][0] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_57x0));
        daGrid[57][1] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_57x1));
        daGrid[57][2] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_57x2));
        daGrid[57][3] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_57x3));
        daGrid[57][4] = new BlankGridSpace((ImageView) findViewById(R.id.grid1_57x4));
        daGrid[57][5] = new WinCircle((ImageView) findViewById(R.id.grid1_57x5), timer);

        daGrid[58][0] = new SquareObstacle((ImageView) findViewById(R.id.grid1_58x0), screenWidth, screenHeight);
        daGrid[58][1] = new SquareObstacle((ImageView) findViewById(R.id.grid1_58x1), screenWidth, screenHeight);
        daGrid[58][2] = new SquareObstacle((ImageView) findViewById(R.id.grid1_58x2), screenWidth, screenHeight);
        daGrid[58][3] = new SquareObstacle((ImageView) findViewById(R.id.grid1_58x3), screenWidth, screenHeight);
        daGrid[58][4] = new SquareObstacle((ImageView) findViewById(R.id.grid1_58x4), screenWidth, screenHeight);
        daGrid[58][5] = new SquareObstacle((ImageView) findViewById(R.id.grid1_58x5), screenWidth, screenHeight);
    ...
    public Hater[] placeEnemies(Hater[] haters)
    {
        ...
        haters[3] = new Hater((ImageView) findViewById(R.id.hater1_3));
        ...
        haters[4] = new Hater((ImageView) findViewById(R.id.hater1_4));
        ...
        haters[5] = new Hater((ImageView) findViewById(R.id.hater1_5));
